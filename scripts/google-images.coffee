...
module.exports = (robot) ->
  robot.respond /(image|img|porn)( me)? (.*)/i, (msg) ->
    imageMe msg, msg.match[3], msg.match[1]=="porn", (url) ->
      msg.send url
...
imageMe = (msg, query, porn, cb) ->
  msg.http('http://ajax.googleapis.com/ajax/services/search/images')
    .query(v: "1.0", rsz: '8', q: query, safe: (if porn then "off" else "moderate"))
    .get() (err, res, body) ->
